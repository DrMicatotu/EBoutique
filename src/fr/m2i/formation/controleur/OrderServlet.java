...
public class OrderServlet extends HttpServlet {
	...
	/*
	 * while(it.hasNext()) { Object key = it.next(); // get key JSONObject o =
	 * (JSONObject) jObj.get(key.toString()); // get value
	 * System.out.println(key + " : " + o); // print the key and value
	 * System.out.println(key); System.out.println(o.get("nameCart"));
